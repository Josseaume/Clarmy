...
<img src=".github/assets/shot-dashboard.png" alt="CLARMY dashboard: the session grid with live state tiles" width="100%" />
<sub>the grid · six-state tiles, live over one socket</sub>

<br/><br/>

<img src=".github/assets/shot-metrics.png" alt="CLARMY metrics: cost, tokens and sessions over time" width="100%" />
<sub>metrics · cost / output / sessions overlaid, per-project and per-model breakdowns</sub>

<br/><br/>

<img src=".github/assets/shot-office.png" alt="CLARMY office: every session is a pixel clawd working at its desk" width="100%" />
<sub>the office · one clawd per session, behavior driven by the real state machine</sub>

</div>

<sub>screenshots are generated by the e2e suite (`pnpm test:e2e`), in mock mode, on every run</sub>
